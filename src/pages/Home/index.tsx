  ...
  return (
    <div className="-mt-7">
      <div className="grid grid-cols-9 gap-0">
        <div className="col-span-2 p-7 pl-10 text-left border-r-1 h-full bg-neutral-800">
        ...
        <div className="col-span-5 text-left p-10">
          ...
          <div className="bg-neutral-800 border-1 shadow-xl rounded px-8 pt-6 pb-8 mb-10 w-100"></div>
          <p className="text-md mb-4">Start building your profile</p>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="bg-neutral-800 border-1 shadow-xl rounded px-4 pt-4 pb-4 mb-4 w-100 h-full">
            ...
            <div>
              <div className="bg-neutral-800 border-1 shadow-xl rounded px-4 pt-4 pb-3 mb-4 w-100 h-full">
